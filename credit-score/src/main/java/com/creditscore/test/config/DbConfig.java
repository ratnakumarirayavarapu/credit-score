package com.creditscore.test.config;
...
@EnableJpaRepositories(basePackages = "com.creditscore.test.repository")
...
public class DbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emf.setPackagesToScan("com.creditscore.test.domain");
